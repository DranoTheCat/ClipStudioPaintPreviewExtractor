...
You can move this folder (including the favicon.ico, and README.txt) wherever you want.

THIS SOFTWARE IS PROVIDED AS-IS WITH ABSOLUTELY NO SUPPORT OR WARRANTY
